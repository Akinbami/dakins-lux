      ...
      <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
        ...
        <div className="mt-20">
          <div className="flex">
            ...
            <p className="border px-5 py-3 text-sm">Reviews (314)</p>
          </div>
          <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum
              quisquam omnis ab. Nesciunt facilis possimus quis odit, optio
              beatae officia sed temporibus repellat exercitationem placeat
              mollitia vitae corporis, perferendis ratione!
            </p>
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum
              quisquam omnis ab. Nesciunt facilis possimus quis odit, optio
